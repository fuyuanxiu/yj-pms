...
public abstract interface FtpClientService {
    ...
    public abstract ApiResponseResult uploadFiles(String paramString1, int paramInt, String paramString2, String paramString3, String paramString4, String[] paramString5, InputStream[] paramInputStream);
