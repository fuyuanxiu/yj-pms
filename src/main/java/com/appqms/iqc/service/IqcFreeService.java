...
public interface IqcFreeService {
    ...
    public ApiResponseResult saveCheckResult(String factory,String company,String username,String pi_pid,String pi_values,String pi_name) throws Exception;
    ...
    public ApiResponseResult doFreeItemField(String factory,String company,String username,String pid,String fielname,String fielval) throws Exception;
